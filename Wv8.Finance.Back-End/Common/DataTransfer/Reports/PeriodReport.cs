namespace PersonalFinance.Common.DataTransfer.Reports
{
    ...
    public class PeriodReport : Report
    {
        ...
        /// </summary>
        public Dictionary<string, decimal> DailyBalances { get; set; }
        ...
        /// <summary>
        /// The totals for the transaction in the period, per category identifier.
        /// Note that entries for categories are only present if they have at least 1 transaction in the period.
        /// </summary>
        public Dictionary<int, TransactionSums> TotalsPerCategory { get; set; }
